...
SELECT
    ...
    bqcarto.h3.LONGLAT_ASH3(lng, lat, 8) AS h3_idx,
    bqcarto.h3.LONGLAT_ASH3(city_lng, city_lat, 5) AS city_h3_idx
FROM
...
(
    SELECT
        ...
        bqcarto.h3.KRING(bqcarto.h3.LONGLAT_ASH3(lng, lat,8), 2) AS h3_idx,
    FROM
